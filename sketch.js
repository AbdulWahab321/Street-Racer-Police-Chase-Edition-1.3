...
async function preload() {
  ...
  bgmp = loadSound("MAIN/MP3/cop_car.mp3")
  ...
  Her=loadSound("MAIN/MP3/Her.mp3")
  gunImg=loadImage("MAIN/gun.png")
  ammoImg=loadImage("MAIN/Missile.png")
  gun1Img=loadImage("MAIN/gun1.png")
  bulletImg=loadImage("MAIN/B.png")
  Cb=loadImage("MAIN/CB.png")
  SImg=loadImage("MAIN/sparkle.png")
  EImg=loadImage("MAIN/E.png")
  CarEX=loadSound("MAIN/MP3/CarEX.wav")
  ShootS=loadSound("MAIN/MP3/MSHS.mp3")
  MissShot=loadSound("MAIN/MP3/MissS.mp3")
  Cm=loadImage("MAIN/CM.png")
}
...
if(gameState!==FIRSTBG&&gameState!==START&&gameState!==SELECTOR&&gameState!==CARSELECTOR&&gameState!==SETTINGS&&gameState!==INS){
  ...
  if (gameState === INS) {
    ...
    text("Be careful Don't Touch Police Cars", 50, 300);
